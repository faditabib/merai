# Graph Report - Merai app  (2026-07-18)

## Corpus Check
- 260 files · ~164,347 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1908 nodes · 3162 edges · 178 communities (119 shown, 59 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ba1b73ae`
...
1. `Merai — Architectural Decisions` - 49 edges
2. `TranscriptWord` - 38 edges
3. `Merai — Progress Log` - 35 edges
...
- `usageGate()` --calls--> `quotaExceeded()`  [EXTRACTED]
  apps/web/src/app/actions/projects.ts → packages/core/src/billing.ts
- `POST()` --calls--> `subscriptionRowFromStripe()`  [EXTRACTED]
  apps/web/src/app/api/stripe/webhook/route.ts → packages/core/src/billing.ts
...
## Communities (178 total, 59 thin omitted)
...
Cohesion: 0.16
Nodes (10): SceneFile, ScenesUploadFlow(), ScenesUploadFlowProps, State, createResumableUpload(), ResumableUploadOptions, supabaseTusEndpoint(), startTusServer() (+2 more)
...
Cohesion: 0.09
Nodes (7): Db, setDb(), PermanentJobError, WORDS, createTestDb(), MIGRATIONS_DIR, TestDb
...
Cohesion: 0.21
Nodes (9): AssemblyAIProvider, AssemblyAIProviderOptions, CUSTOM_SPELLING, MockTranscriptionProvider, assemblyAiToResult(), AssemblyAiTranscript, TranscriptionProvider, TranscriptionRequest (+1 more)
...
Cohesion: 0.07
Nodes (27): Build 5.5 — AI Editing Brain v1 (2026-07-11), Build 5.6 — AI Brain UX polish + feedback loop (2026-07-11), Build 5 — Professional editing core: EDL v2 foundation (2026-07-11), Build 6A.1 — Visual QA fixes + production redeploy (2026-07-11), Build 6A — Creator experience layer (2026-07-11), Build 6B.1 — Creator Identity Layer (2026-07-11), Build 6B.2 — Caption Studio (2026-07-12), Build 6B.3 — Caption Studio UX (2026-07-12) (+19 more)
...
Cohesion: 0.04
Nodes (49): 2026-07-08 — 10-minute cap enforced in three layers, no ffprobe infra, 2026-07-08 — Arabic language handling: keep auto-detection, no pin, 2026-07-08 — Auth: Supabase email+password to start, 2026-07-08 — Brand terms: AssemblyAI custom_spelling adopted, word_boost rejected, 2026-07-08 — Browser locale detection disabled, 2026-07-08 — DB-level tests run on PGlite applying the real migrations, 2026-07-08 — EDL is versioned, immutable, append-only JSON (v1 single-track), 2026-07-08 — Enum-like columns are text + CHECK constraints, not Postgres enums (+41 more)
...
Cohesion: 0.13
Nodes (17): createEditBrain(), EditBrain, HaikuEditBrain, MessageCreator, PLAN_TOOL, renderState(), generateEdl(), resolveIntentHint() (+9 more)

### Community 95 - "projects.ts"
Cohesion: 0.11
Nodes (18): 10. Production-readiness testing, 1. Executive summary, 2. Security score, 3. CRITICAL vulnerabilities, 4. HIGH priority issues, 5. MEDIUM priority issues, 6. LOW priority issues, 7. Reliability issues (verified during the hardening sprint + this audit) (+10 more)

### Community 96 - "project-status-view.tsx"
Cohesion: 0.07
Nodes (27): 1. Upload pipeline — honest limits (the critical blocker's UX fix), 2. Project lifecycle — rename / delete / archive, 3. Error quality, 4. Dead configuration removed, 5. Verification, Functional Readiness Report — 2026-07-18, Remaining known limitations, 1. What is genuinely working (verified live this session) (+19 more)
...
Cohesion: 0.16
Nodes (16): TimelineProps, EditBrainInput, CaptionLine, EdlV1, buildExportPlan(), CaptionOverlayPlan, CaptionSequenceEntry, ENCODE_ARGS (+8 more)
...
Cohesion: 0.18
Nodes (17): CaptionPreview(), captionSpanStyle(), CreatorStylePreview(), CreatorStylePreviewProps, CaptionOverlay(), activeCaptionIndex(), activeWordIndex(), buildCaptionLines() (+9 more)
...
Cohesion: 0.20
Nodes (18): applyEditCommand(), edlV1Schema, KeptSegment, keptSegmentSchema, nextSegmentId(), outputToSourceMs(), removeWords(), reorderSegment() (+10 more)
...
Cohesion: 0.26
Nodes (14): deleteProject(), ProjectCard(), ProjectCardProps, STATUS_STYLES, ExplorerProject, ProjectsExplorer(), ProjectsExplorerProps, addTag() (+6 more)

### Community 109 - "upload-flow.tsx"
Cohesion: 0.14
Nodes (13): 1. First-user experience — 7/10, 2. Navigation & IA — 6/10, 3. Recording studio — 7/10 (core product, highest stakes), 4. Dashboard — 8/10, 5. Editor / studio — 7/10, 6. Design system consistency — 8/10, 7. Error handling — 6.5/10, 8. Mobile — 7/10 (+5 more)

### Community 110 - "brand-kit-form.tsx"
Cohesion: 0.11
Nodes (17): Box, brandExportConfigSchema, gradientOverlayConfigSchema, HexColor, hexColorSchema, LogoOverlayConfig, logoOverlayConfigSchema, lowerThirdConfigSchema (+9 more)
...
Cohesion: 0.23
Nodes (9): defaultDeps, execFileAsync, ffmpegStitch(), handoffToTranscribe(), stitch(), StitchDeps, stitchWithDeps(), UploadRow (+1 more)

### Community 132 - "transcribe.ts"
Cohesion: 0.20
Nodes (16): createProjectWithScenes(), createProjectWithUpload(), CreateScenesResult, CreateUploadResult, currentBillingPeriod(), requestExportRender(), usageGate(), ALLOWED_VIDEO_MIME_TYPES (+8 more)
...
Cohesion: 0.24
Nodes (9): env, cgroupMemoryMb(), execFileAsync, LocalFfmpegEngine, RenderAbortedError, RenderEngine, RenderRequest, VeryGoodFfmpegEngine (+1 more)
...
Cohesion: 0.20
Nodes (14): BrandKitFormProps, GRADIENT_DEFAULTS, LOGO_TYPES, CreatorStyles(), CreatorStylesProps, GradientOverlayConfig, LogoOverlayPref, LowerThirdConfig (+6 more)

### Community 143 - "EdlV1"
Cohesion: 0.13
Nodes (13): 1. Scope & the one modeling decision, 2. Database (first migration since 6B — additive, idempotent), 3. Web, 4. Files, 5. Risks, 6. Verification, Build 7.7 Analysis — Project Organization, 1. What was built (+5 more)
...
Cohesion: 0.15
Nodes (16): GET(), BrandKitPage(), NewProjectPage(), OnboardingPage(), RecordPage(), AppHeader(), BrandKitForm(), LocaleSwitcher() (+8 more)

### Community 146 - "generate-edl.test.ts"
Cohesion: 0.10
Nodes (25): requestAiEdit(), AiAssistantPanel(), FEEDBACK_REASONS, INTENTS, PRESET_KEYS, SuggestionRow, AI_FEEDBACK_REASONS, AI_FEEDBACK_VALUES (+17 more)
...
Cohesion: 0.19
Nodes (17): EditorView(), ShortcutsHelp(), ReorderDrag, Timeline(), TrimDrag, WaveformStrip, buildPeaks(), decodePeaksFromMedia() (+9 more)

### Community 154 - "Build 7.4 Report — Scenes + Worker Stitch (multi-clip recording projects)"
Cohesion: 0.29
Nodes (7): 1. What was built, 2. Zero migrations — verified against the schema, 3. Tests (195 → 206), 4. Verification (live backend + real ffmpeg), 5. Live stitch run (real ffmpeg, live queue, live providers), 6. Production, Build 7.4 Report — Scenes + Worker Stitch (multi-clip recording projects)

### Community 155 - "Build 7.5 Analysis — Auto Canvas"
Cohesion: 0.13
Nodes (13): 1. What Auto Canvas is here, 2. Rules (deterministic, tested), 3. Integration, 4. Files, 5. DB/worker impact, 6. Verification, Build 7.5 Analysis — Auto Canvas, 1. What was built (+5 more)

### Community 156 - "brand.ts"
Cohesion: 0.17
Nodes (17): images, line, defaultDeps, ExportRow, renderExport(), RenderExportDeps, renderExportWithEngine(), renderLogoImage() (+9 more)

### Community 157 - "limits.ts"
Cohesion: 0.13
Nodes (13): 1. What a Merai Skill IS (the foundation decision), 2. The six launch skills, 3. Integration (zero worker change), 4. Files, 5. Deferred (explicitly), 6. Verification, Build 8 Analysis — Skills Foundation (Merai Skills Marketplace), 1. What was built (+5 more)

### Community 159 - "TranscriptWord"
Cohesion: 0.18
Nodes (17): BillingPage(), currentBillingPeriod(), ACTIVE_SUBSCRIPTION_STATUSES, BILLING_INTERVALS, BillingInterval, limitForKind(), planForLookupKey(), quotaExceeded() (+9 more)

### Community 160 - "CreatorStyle"
Cohesion: 0.07
Nodes (28): 1. Scores, 2. Per-area review (first-time creator lens), 3. Top 20 improvements, ranked by impact, 4. Buckets, 5. Future improvements review (evaluated, NOT implemented), 6. Recommended next-cycle sprint backlog (post user-testing), Accessibility, Auto Canvas (7.5) — right architecture, one UX wart (+20 more)

### Community 161 - "arabic.ts"
Cohesion: 0.16
Nodes (11): arabicFixture, takeOne, takeTwo, buildFixture(), WordSpec, englishFixture, restart, takeOne (+3 more)

### Community 162 - "edl.ts"
Cohesion: 0.11
Nodes (16): 1. What already exists (Build 9 completes a loop, it doesn't start one), 2. The provider decision (the house pattern, again), 3. Data (one migration, additive), 4. Core `billing.ts` (pure, tested), 5. Enforcement (server-authoritative), 6. Surfaces, 7. Enterprise-readiness (architecture note), 8. Blocker declared honestly (+8 more)

### Community 163 - "provider.ts"
Cohesion: 0.17
Nodes (7): BillingProvider, CheckoutInput, form(), MockBillingProvider, StripeBillingProvider, stripeRequest(), BillingPlan

### Community 164 - "onboarding-wizard.tsx"
Cohesion: 0.26
Nodes (12): LOGO_TYPES, OnboardingWizard(), OnboardingWizardProps, TYPE_ICONS, BrandKitRow, CREATOR_STYLES, getCreatorStyle(), CREATOR_TYPE_IDS (+4 more)

### Community 165 - "transcribe.ts"
Cohesion: 0.18
Nodes (15): cleanupExpired(), handlers, JobHandler, enqueueAnalyze(), ProjectRow, transcribe(), transcribeWithProvider(), UploadRow (+7 more)

### Community 166 - "createClient"
Cohesion: 0.21
Nodes (6): AuthForm(), cache, ProjectThumbnail(), ProjectThumbnailProps, SignOutButton(), createClient()

### Community 167 - "OverlayPosition"
Cohesion: 0.25
Nodes (11): OverlayStudio(), OverlayStudioProps, placement(), POSITIONS, applyAutoLayout(), autoCaptionAnchor(), AutoLayout, AutoLayoutInput (+3 more)

### Community 168 - "edl.ts"
Cohesion: 0.23
Nodes (11): AI_INTENTS, catalog, getSkill(), recommendedSkills(), SKILL_IDS, SkillDefinition, skillDefinitionSchema, SkillId (+3 more)

### Community 169 - "upload-flow.tsx"
Cohesion: 0.21
Nodes (5): UploadFlow(), UploadFlowProps, UploadState, probeVideoDurationSeconds(), ResumableUploadHandle

### Community 170 - "billing.ts"
Cohesion: 0.38
Nodes (9): openBillingPortal(), siteUrl(), startCheckout(), BillingPanel(), BillingPanelProps, createBillingProvider(), BILLING_PLANS, getPlan() (+1 more)

### Community 171 - "caption-studio.tsx"
Cohesion: 0.15
Nodes (22): CaptionPreviewProps, anchorToPosition(), CaptionStudio(), CaptionStudioProps, DEFAULT_OUTLINE, Position, POSITION_ANCHOR, TEXT_SWATCHES (+14 more)

### Community 172 - "createAdminClient"
Cohesion: 0.29
Nodes (7): completeUpload(), finalizeScenes(), retryProcessing(), POST(), signStripePayload(), verifyStripeSignature(), createAdminClient()

### Community 173 - "jobs.ts"
Cohesion: 0.18
Nodes (10): AnalyzePayload, cleanupExpiredPayloadSchema, GenerateEdlPayload, generateEdlPayloadSchema, JobStatus, jobStatusSchema, RenderExportPayload, renderExportPayloadSchema (+2 more)

### Community 174 - "index.ts"
Cohesion: 0.36
Nodes (6): AiDecisionCard(), anchorFor(), CardAnchor, TranscriptPanel(), TranscriptPanelProps, RemovedSegment

### Community 175 - "brand.ts"
Cohesion: 0.39
Nodes (6): renderBrandImages(), renderGradientImage(), renderLowerThirdImage(), rgba(), registerCaptionFonts(), LOGO_CFG

### Community 177 - "storage.ts"
Cohesion: 0.83
Nodes (3): requireEnv(), createSignedMediaUrl(), getServiceClient()

## Knowledge Gaps
- **952 isolated node(s):** `eslintConfig`, `withNextIntl`, `nextConfig`, `name`, `version` (+947 more)
...
- **Why does `TranscriptWord` connect `editor-view.tsx` to `edl-v2.ts`, `Server Render Pipeline`, `AI Analysis & EDL Builder`, `Transcription Providers`, `TranscriptWord`, `edl-ops.ts`, `caption-studio.tsx`, `limits.ts`, `index.ts`, `brand-kit-form.tsx`, `generate-edl.test.ts`, `edl.ts`, `createClient`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `EdlV1` connect `editor-view.tsx` to `edl-v2.ts`, `Server Render Pipeline`, `AI Analysis & EDL Builder`, `TranscriptWord`, `edl-ops.ts`, `caption-studio.tsx`, `limits.ts`, `index.ts`, `brand-kit-form.tsx`, `render-export.test.ts`, `generate-edl.test.ts`, `edl.ts`, `brand.ts`, `createClient`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `createClient()` connect `createClient` to `Web Upload & Project UI`, `onboarding-wizard.tsx`, `upload-flow.tsx`, `caption-studio.tsx`, `export-plan.ts`, `limits.ts`, `fillers.ts`, `edl.ts`, `generate-edl.test.ts`, `edl.ts`, `RenderRequest`?**
