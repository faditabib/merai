...
## Corpus Check
- 200 files · ~123,297 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1444 nodes · 2373 edges · 143 communities (86 shown, 57 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 3 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0ee08570`
...
1. `Merai — Architectural Decisions` - 39 edges
2. `TranscriptWord` - 38 edges
3. `EdlV1` - 29 edges
4. `Merai — Progress Log` - 23 edges
5. `getDb()` - 22 edges
...
## Communities (143 total, 57 thin omitted)
...
Cohesion: 0.12
Nodes (15): Build 5.5 — AI Editing Brain v1 (2026-07-11), Build 5.6 — AI Brain UX polish + feedback loop (2026-07-11), Build 5 — Professional editing core: EDL v2 foundation (2026-07-11), Build 6A.1 — Visual QA fixes + production redeploy (2026-07-11), Build 6A — Creator experience layer (2026-07-11), Build 6B.1 — Creator Identity Layer (2026-07-11), Build 6B.2 — Caption Studio (2026-07-12), Build 6B.3 — Caption Studio UX (2026-07-12) (+7 more)
...
Cohesion: 0.05
Nodes (39): 2026-07-08 — 10-minute cap enforced in three layers, no ffprobe infra, 2026-07-08 — Arabic language handling: keep auto-detection, no pin, 2026-07-08 — Auth: Supabase email+password to start, 2026-07-08 — Brand terms: AssemblyAI custom_spelling adopted, word_boost rejected, 2026-07-08 — Browser locale detection disabled, 2026-07-08 — DB-level tests run on PGlite applying the real migrations, 2026-07-08 — EDL is versioned, immutable, append-only JSON (v1 single-track), 2026-07-08 — Enum-like columns are text + CHECK constraints, not Postgres enums (+31 more)
...
Cohesion: 0.10
Nodes (23): AiAssistantPanel(), FEEDBACK_REASONS, INTENTS, PRESET_KEYS, SuggestionRow, AI_FEEDBACK_REASONS, AI_FEEDBACK_VALUES, AI_INTENTS (+15 more)
...
Cohesion: 0.32
Nodes (10): EditorView(), EditorViewProps, ShortcutsHelp(), Timeline(), BrandExportConfig, applyEditCommands(), edlOutputDurationMs(), nextSegmentAfterSource() (+2 more)
...
Cohesion: 0.11
Nodes (34): CaptionPreview(), CaptionPreviewProps, captionSpanStyle(), anchorToPosition(), CaptionStudio(), CaptionStudioProps, DEFAULT_OUTLINE, Position (+26 more)
...
Cohesion: 0.11
Nodes (20): createEditBrain(), generateEdl(), resolveIntentHint(), handlers, JobHandler, validateAiEditPlan(), AnalyzePayload, analyzePayloadSchema (+12 more)
...
Cohesion: 0.14
Nodes (13): EditBrain, HaikuEditBrain, MessageCreator, PLAN_TOOL, renderState(), AI_EDIT_CATEGORIES, AI_EDIT_COMMAND_TYPES, AiEditPlan (+5 more)

### Community 110 - "brand-kit-form.tsx"
Cohesion: 0.06
Nodes (56): BrandKitPage(), BrandKitForm(), BrandKitFormProps, GRADIENT_DEFAULTS, LOGO_TYPES, CreatorStylePreview(), CreatorStylePreviewProps, CreatorStyles() (+48 more)
...
Cohesion: 0.09
Nodes (8): Db, PermanentJobError, OutputTooLargeError, WORDS, createTestDb(), MIGRATIONS_DIR, TestDb, render()

### Community 131 - "generate-edl.test.ts"
Cohesion: 0.20
Nodes (14): GET(), NewProjectPage(), OnboardingPage(), EditorPage(), ProjectPage(), AppHeader(), ProjectSnapshot, ProjectStatusView() (+6 more)
...
### Community 143 - "EdlV1"
Cohesion: 0.20
Nodes (13): AiDecisionCard(), ReorderDrag, TimelineProps, TrimDrag, anchorFor(), CardAnchor, TranscriptPanel(), TranscriptPanelProps (+5 more)
...
## Knowledge Gaps
- **716 isolated node(s):** `eslintConfig`, `withNextIntl`, `nextConfig`, `name`, `version` (+711 more)
...
- **Why does `TranscriptWord` connect `EdlV1` to `editor-view.tsx`, `generate-edl.test.ts`, `transcribe.ts`, `AI Analysis & EDL Builder`, `Transcription Providers`, `TranscriptWord`, `edl-v2.ts`, `edl-ops.ts`, `export-plan.ts`, `upload-flow.tsx`, `brand-kit-form.tsx`, `RenderRequest`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `EdlV1` connect `EdlV1` to `editor-view.tsx`, `generate-edl.test.ts`, `Server Render Pipeline`, `AI Analysis & EDL Builder`, `render-export.test.ts`, `TranscriptWord`, `edl-v2.ts`, `edl-ops.ts`, `export-plan.ts`, `upload-flow.tsx`, `brand-kit-form.tsx`, `edl.ts`, `RenderRequest`?**
