...
## Corpus Check
- 206 files · ~127,948 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1496 nodes · 2465 edges · 146 communities (89 shown, 57 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 3 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `49b5c1d3`
...
1. `Merai — Architectural Decisions` - 40 edges
2. `TranscriptWord` - 38 edges
3. `EdlV1` - 29 edges
4. `Merai — Progress Log` - 24 edges
...
Cohesion: 0.21
Nodes (15): BrandKitFormProps, GRADIENT_DEFAULTS, LOGO_TYPES, CreatorStylePreviewProps, CreatorStyles(), CreatorStylesProps, OverlayStudio(), OverlayStudioProps (+7 more)
...
Cohesion: 0.08
Nodes (35): images, line, env, requireEnv(), defaultDeps, renderExport(), RenderExportDeps, renderExportWithEngine() (+27 more)

### Community 5 - "AI Analysis & EDL Builder"
Cohesion: 0.23
Nodes (10): ANALYSIS_TOOL, HaikuAnalysisEngine, MessageCreator, renderTranscript(), HeuristicAnalysisEngine, AnalysisEngine, AnalysisInput, AnalysisResult (+2 more)
...
Cohesion: 0.08
Nodes (28): Phase, RecordFlow(), SetupError, Take, UploadFlow(), containerOfMime(), createElapsedTracker(), ElapsedTracker (+20 more)
...
Cohesion: 0.12
Nodes (16): Build 5.5 — AI Editing Brain v1 (2026-07-11), Build 5.6 — AI Brain UX polish + feedback loop (2026-07-11), Build 5 — Professional editing core: EDL v2 foundation (2026-07-11), Build 6A.1 — Visual QA fixes + production redeploy (2026-07-11), Build 6A — Creator experience layer (2026-07-11), Build 6B.1 — Creator Identity Layer (2026-07-11), Build 6B.2 — Caption Studio (2026-07-12), Build 6B.3 — Caption Studio UX (2026-07-12) (+8 more)
...
Cohesion: 0.05
Nodes (40): 2026-07-08 — 10-minute cap enforced in three layers, no ffprobe infra, 2026-07-08 — Arabic language handling: keep auto-detection, no pin, 2026-07-08 — Auth: Supabase email+password to start, 2026-07-08 — Brand terms: AssemblyAI custom_spelling adopted, word_boost rejected, 2026-07-08 — Browser locale detection disabled, 2026-07-08 — DB-level tests run on PGlite applying the real migrations, 2026-07-08 — EDL is versioned, immutable, append-only JSON (v1 single-track), 2026-07-08 — Enum-like columns are text + CHECK constraints, not Postgres enums (+32 more)
...
Cohesion: 0.06
Nodes (38): AiAssistantPanel(), FEEDBACK_REASONS, INTENTS, PRESET_KEYS, SuggestionRow, EditBrain, EditBrainInput, HaikuEditBrain (+30 more)
...
Cohesion: 0.06
Nodes (50): completeUpload(), createProjectWithUpload(), CreateUploadResult, requestAiEdit(), requestExportRender(), retryProcessing(), GET(), BrandKitPage() (+42 more)
...
Cohesion: 0.40
Nodes (8): EditorView(), ShortcutsHelp(), Timeline(), applyEditCommands(), edlOutputDurationMs(), nextSegmentAfterSource(), segmentAtSource(), sourceToOutputMs()
...
Cohesion: 0.20
Nodes (15): CreatorStylePreview(), CaptionOverlay(), activeCaptionIndex(), activeWordIndex(), buildCaptionLines(), CAPTION_PRESET_IDS, CAPTION_PRESETS, CaptionAnimation (+7 more)
...
Cohesion: 0.14
Nodes (12): Box, brandExportConfigSchema, HexColor, logoBox(), LogoOverlayConfig, logoOverlayConfigSchema, lowerThirdConfigSchema, lowerThirdShapeSchema (+4 more)
...
Cohesion: 0.29
Nodes (8): WordRange, buildEdl(), BuildEdlInput, WordRemoval, build(), NO_ANALYSIS, RemovalReason, TranscriptWord

### Community 110 - "brand-kit-form.tsx"
Cohesion: 0.16
Nodes (18): LOGO_TYPES, OnboardingWizard(), OnboardingWizardProps, TYPE_ICONS, AI_INTENTS, BrandKitRow, gradientOverlayConfigSchema, hexColorSchema (+10 more)
...
Cohesion: 0.05
Nodes (46): createEditBrain(), sendAlert(), Db, getDb(), setDb(), PermanentJobError, cleanupExpired(), generateEdl() (+38 more)
...
Cohesion: 0.31
Nodes (7): createAnalysisEngine(), analyze(), analyzeWithEngine(), TranscriptRow, Level, log, write()

### Community 140 - "limits.ts"
Cohesion: 0.25
Nodes (5): SubscriptionTier, TIER_LIMITS, TierLimits, transcriptWordSchema, transcriptWordsSchema
...
### Community 143 - "EdlV1"
Cohesion: 0.24
Nodes (10): AiDecisionCard(), ReorderDrag, TimelineProps, TrimDrag, anchorFor(), CardAnchor, TranscriptPanel(), TranscriptPanelProps (+2 more)
...
## Knowledge Gaps
- **741 isolated node(s):** `eslintConfig`, `withNextIntl`, `nextConfig`, `name`, `version` (+736 more)
...
- **Why does `EdlV1` connect `EdlV1` to `project-status-view.tsx`, `editor-view.tsx`, `render-export.test.ts`, `transcribe.ts`, `Server Render Pipeline`, `edl-v2.ts`, `TranscriptWord`, `edl-ops.ts`, `caption-studio.tsx`, `export-plan.ts`, `upload-flow.tsx`, `edl.ts`, `RenderRequest`, `createClient`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `TranscriptWord` connect `upload-flow.tsx` to `project-status-view.tsx`, `editor-view.tsx`, `edl-v2.ts`, `AI Analysis & EDL Builder`, `Transcription Providers`, `TranscriptWord`, `edl-ops.ts`, `caption-studio.tsx`, `export-plan.ts`, `limits.ts`, `EdlV1`, `RenderRequest`, `createClient`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `TranscriptionProvider` connect `Transcription Providers` to `render-export.test.ts`?**
