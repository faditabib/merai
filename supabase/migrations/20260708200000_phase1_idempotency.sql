...
create unique index transcripts_upload_uidx on public.transcripts (upload_id);
...
create unique index usage_ledger_upload_uidx on public.usage_ledger (upload_id);
